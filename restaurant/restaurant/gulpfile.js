...
gulp.task('fix-paths-for-gh-pages', cb => {
	...
	files.forEach(filePath => {
		...
		// Bulletproof prefixing of all internal href/src attributes (both relative and absolute)
		content = content.replace(/href=(["'])(?!\/\/|https?:\/\/|#|mailto:)(?:IT499-Capstone\/)?\/?([^"']*)\1/g, 'href="/IT499-Capstone/$2"');
		content = content.replace(/src=(["'])(?!\/\/|https?:\/\/|#)(?:IT499-Capstone\/)?\/?([^"']*)\1/g, 'src="/IT499-Capstone/$2"');
